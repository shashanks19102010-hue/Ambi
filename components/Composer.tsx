...
export default function Composer({ onSend, busy, webSearch, onToggleResearch }: { onSend: (value: string) => void; busy: boolean; webSearch: boolean; onToggleResearch: () => void }) {
