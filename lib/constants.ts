...
export const MODEL_CATALOG = [
  {
    id: "LFM2.5-350M-Instruct-q4f16_1-MLC",
    name: "LFM2.5 350M Instruct",
    sizeLabel: "~250 MB",
...
- Do not expose private chain-of-thought. Give concise explanations, conclusions and useful reasoning summaries instead.
`;
