...
export const CLOUD_MODEL_CATALOG=[
 {id:DEFAULT_CLOUD_MODEL_ID,name:"GPT OSS 120B",description:"Best overall for reasoning, coding and advanced tasks.",contextWindow:131_072,maxOutputTokens:65_536,tier:"High Performance"},
...
export const DEFAULT_SETTINGS:AppSettings={model:DEFAULT_CLOUD_MODEL_ID,webSearch:false,memoryEnabled:true,responseStyle:"normal",language:"auto",theme:"system",reducedMotion:false,temporaryChat:false};
