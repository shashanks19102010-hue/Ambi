...
export const MAX_CONTEXT_CHARS=36_000;
...
export const CLOUD_MODEL_CATALOG=[
  ...
  {id:"llama-3.3-70b-versatile",name:"Llama 3.3 70B",description:"Strong general chat and multilingual responses.",contextWindow:131_072,maxOutputTokens:32_768,tier:"Powerful"},
  {id:"llama-3.1-8b-instant",name:"Llama 3.1 8B Instant",description:"Fast lightweight option for quick answers.",contextWindow:131_072,maxOutputTokens:8_192,tier:"Standard"},
] as const;
...
When external sources are provided, cite the source identifiers supplied by the application rather than inventing citations.`;
